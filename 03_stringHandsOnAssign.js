function stringHandsOn() {
  ...
  console.log(
    `###1. Given string is "     Hey you are doing good, keep it up     "`
  );
  ...
  console.log("");
  console.log(
    `###3. String after removing leading and trailing extra spaces= `,
    trimedString
  );
  ...
  console.log("");
  console.log(
    `###5. First character after trim is `,
    trimedString.charAt(0),
    `and last character after trim is `,
    trimedString.charAt(stringlen - 1)
  );
  ...
  console.log("");
  console.log(
    `###10. Is string starts with word "Hey" after trimming - `,
    start
  );
}
stringHandsOn();
